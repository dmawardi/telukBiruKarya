export default {
  en: {
    index: {
      text: 'PT Teluk Biru Karya is an innovative company that produces and works/consults with other organizations to produce products that customers love.  In an increasingly price competitive world, PT TBK stands out as a player that aims to achieve value for the premium market.  Through challenging the current paradigm, PT TBK aims to proviide an offering that captures the imagination of our customers and responds to their needs in a truly distinctive way.  We are always open to working with new partners, so please feel free to reach out to us using the Contact form on this website!',
      vision:
      ...
      companyFacets: [
        ...
        },
        {
          ...
          aspectCaption:
            'PT Teluk Biru Karya is extraordinarily capable in navigating new and challenging terrain.  The combined experience of our team members will ensure that PT TBK will thrive in an increasingly unpredictable future',
          color: 'black',
        },
      ],
    },
    contact: {
      text: 'Please feel free to use the form below to reach out to us with any business enquiries you may have.  We are always open to collaborate on new projects with like-minded partners!',
    },
    about: {
      aboutSubtitle:
        'At PT TBK, we believe in working smart, challenging your assumptions, & executing with precision.',
      aboutText:
        'PT TBK was established in September, 2021, by its founders: Danar Mawardi & Calvin Santoso.  This was to answer the need in the market for products that provide sustainability and balance to the wider community.  With a world increasingly focused on the short-term, PT TBK aims to build lasting products that have loyal customers.  We do this through detailed research and building unique brands that capture the imagination of the community.  We hope to create impactful and positive changes in industries in which we operate, by challenging the current status quo and finding a better way.',
    },
    brands: {
      list: [
        {
